<template lang="html">
  <div class="">
    <div class="echarts-container">
      <div class="echarts">
        <div class="echarts-item" v-line:series="data">

        </div>
      </div>

      <div class="line"></div>
      <div class="echarts" style="height:600px;">
        <div class="echarts-item" v-bar:data="barData" style="height:600px;">
...
Vue.directive('bar',{
  inserted : function(el,binding,vnode){
    ...
    //console.log(binding.value)
    //获取指令上的绑定数据
    var dataMap = binding.value.dataMap;
    //console.log(dataMap);
    var option = {
        baseOption: {
            timeline: {
...
export default {
  ...
  computed : {        //来自echarts.js传递过来的数据
    ...
    barData (){
      return this.$store.state.echarts.barData;
    }
  }
}
</script>
